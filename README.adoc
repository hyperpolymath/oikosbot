...
affinescript#425). What remains is the in-repo wiring: binding the HTTP listener
and connecting the webhook → analyse → comment orchestration (today the handlers
accept and return `202` without dispatching).
