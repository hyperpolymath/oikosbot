...
otherwise unrelated.
This document describes the *target* platform architecture; for current implementation status see link:README.adoc[README.adoc], link:EXPLAINME.adoc[EXPLAINME.adoc] and link:.machine_readable/descriptiles/STATE.a2ml[STATE.a2ml].
====
