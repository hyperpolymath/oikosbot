...
type: Opaque
stringData:
  # Illustrative keys only. Inject all three values at deployment time from
  # your secrets manager; do not commit even example-shaped credentials.
  GITHUB_APP_ID: "<inject-at-deploy-time>"
  GITHUB_PRIVATE_KEY: "<inject-at-deploy-time>"
  GITHUB_WEBHOOK_SECRET: "<inject-at-deploy-time>"
----
